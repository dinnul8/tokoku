        ...
        <div class="box">
            <div class="box-header with-border">
                <div class="btn-group">
                    ...
                    <button onclick="cetakPDF('{{ route('produk.export_pdf') }}')" class="btn btn-danger btn-xs btn-flat"><i class="fa fa-file-excel-o"></i> Export PDF</button>
                    <a href="{{ route('produk.export_excel') }}" class="btn btn-success btn-xs btn-flat"><i class="fa fa-file-excel-o"></i> Export Excel</a>
                </div>
            </div>
